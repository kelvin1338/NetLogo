...
to go
  ...
  if (ticks mod (7 * 24) = 0) and ((ticks < (120 * 24)) or (ticks > 154 * 24)) [
    infect_people 2
    ;(0.25 * count humans * (initial_infected_proportion / 100))
  ]

  if (ticks mod (7 * 24) = 0) and ((ticks > (120 * 24)) and (ticks < 154 * 24)) [
    infect_people 10
    ;(0.25 * count humans * (initial_infected_proportion / 100))
  ]
  ...
  if ticks = (126 * 24) [
    set social_distancing_metres 0
...
86
Force-outbreak
infect_people round (0.5 * count humans * (initial_infected_proportion / 100))\n
NIL
1
T
OBSERVER
