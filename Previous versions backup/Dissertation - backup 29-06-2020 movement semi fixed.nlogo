...
to go
 ...
 ;here, create: if confine city is toggled, then if current city != home city, move back to home city
;  ask humans [
;    if confine_city_travel? [
;      if current_city != initial_city [
;        face home_patch forward 3
;      ]
;    ]
;  ]
  ask humans [infect]
...
1527
337
Intracity travellers move quickly, but does not leave the city. Meaningless if confined cities is turned off
10
0.0
1
