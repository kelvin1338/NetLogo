...
to go
  ...
  if (ticks mod (7 * 24) = 0) and (ticks > (15 * 24) and ticks < (52 * 24)) [
  infect_people 6
  ]


  if (ticks mod (7 * 24) = 0) and (ticks >= (52 * 24)) [
  infect_people 15
  ]
  ...
  if ticks = (7 * 24) [
    ...
    set confine_city_travel? true
    set social_distancing_metres 0.5
  ]

  if ticks = (10 * 24) [
    set social_distancing_metres 1.0
  ]
  ...
  if ticks = (42 * 24) [
    ...
    set social_distancing_metres 1
  ]
